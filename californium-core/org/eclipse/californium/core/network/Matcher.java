...
public class Matcher {
	...
	public Exchange receiveRequest(Request request) {
		...
		if (!request.getOptions().hasBlock1() && !request.getOptions().hasBlock2()) {
			...
			if (previous == null) {
				...
				//TODO Logger.info("Message is a duplicate, ignore: "+request);
			...
			if (ongoing != null) {
				...
				if (prev != null) {
					//TODO Logger.info("Message is a duplicate: "+request);
					request.setDuplicate(true);
				}
				return ongoing;
	...
	public Exchange receiveEmptyMessage(EmptyMessage message) {
		...
		if (exchange != null) {
			...
			//TODO Logger.info("Matcher received empty message that does not match any exchange: "+message);
			// ignore message;
			return null;
