	...
	private class Rotation implements Runnable {
		...
		public void run() {
			try {
				...
				//TODO Logger.log(Level.WARNING, "Exception in Crop-Rotation algorithm", t);
			
			} finally {
				try {
					schedule();
				} catch (Throwable t) {
					//TODO Logger.log(Level.WARNING, "Exception while scheduling Crop-Rotation algorithm", t);
				}
			}
		}
