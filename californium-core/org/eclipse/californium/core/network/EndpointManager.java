...
public class EndpointManager {
	...
	public Endpoint getDefaultEndpoint() {
		try {
			...
			//TODO Logger.log(Level.SEVERE, "Exception while getting the default endpoint", e);
		}
	...
	private synchronized void createDefaultEndpoint() throws UnknownHostException {
		...
		try {
			...
			//TODO Logger.log(Level.INFO, "Created implicit default endpoint " + default_endpoint.getAddress());
		} catch (IOException e) {
			//TODO Logger.log(Level.SEVERE, "Could not create default endpoint", e);
		}
	}
	...
	public void setDefaultEndpoint(Endpoint endpoint) {
		...
		if (!this.default_endpoint.isStarted()) {
			try {
				default_endpoint.start();
				//TODO Logger.log(Level.INFO, "Started new default endpoint " + default_endpoint.getAddress());
			} catch (IOException e) {
				//TODO Logger.log(Level.SEVERE, "Could not start new default endpoint", e);
			}
		}
	}
	...
	public Endpoint getDefaultSecureEndpoint() {
		try {
			...
			//TODO Logger.log(Level.SEVERE, "Exception while getting the default secure endpoint", e);
		}
	...
	public void setDefaultSecureEndpoint(Endpoint endpoint) {
		...
		if (!this.default_secure_endpoint.isStarted()) {
			try {
				...
				//TODO Logger.log(Level.INFO, "Started new default secure endpoint " + default_endpoint.getAddress());
			} catch (IOException e) {
				//TODO Logger.log(Level.SEVERE, "Could not start new default secure endpoint", e);
			}
		}
	}
