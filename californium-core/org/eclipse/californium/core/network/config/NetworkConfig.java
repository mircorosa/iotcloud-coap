...
public class NetworkConfig {
	...
	public static NetworkConfig createStandardWithoutFile() {
		//TODO Logger.info("Creating standard network configuration properties without a file");
	...
	public static NetworkConfig createStandardWithFile(File file) {
		...
		if (file.exists()) {
			//TODO Logger.info("Loading standard properties from file "+file);
			try {
				standard.load(file);
			} catch (IOException e) {
				//TODO Logger.log(Level.WARNING, "Error while loading properties from "+file.getAbsolutePath(), e);
			}
		} else {
			//TODO Logger.info("Storing standard properties in file "+file);
			try {
				standard.store(file);
			} catch (IOException e) {
				//TODO Logger.log(Level.WARNING, "Error while storing properties to "+file.getAbsolutePath(), e);
			}
		}
		return standard;
	}
	...
	public int getInt(String key) {
		...
		if (value != null) {
			try {
				...
				//TODO Logger.log(Level.WARNING, "Could not convert property \"" + key + "\" with value \"" + value + "\" to integer", e);
			}
		} else {
	...
	public long getLong(String key) {
		...
		if (value != null) {
			try {
				...
				//TODO Logger.log(Level.WARNING, "Could not convert property \"" + key + "\" with value \"" + value + "\" to long", e);
				return 0;
			}
		} else {
			LOGGER.warning("Property \"" + key + "\" is undefined");
	...
	public float getFloat(String key) {
		...
		if (value != null) {
			try {
				...
				//TODO Logger.log(Level.WARNING, "Could not convert property \"" + key + "\" with value \"" + value + "\" to float", e);
				return 0;
			}
		} else {
			LOGGER.warning("Property \"" + key + "\" is undefined");
	...
	public double getDouble(String key) {
		...
		if (value != null) {
			try {
				...
				//TODO Logger.log(Level.WARNING, "Could not convert property \"" + key + "\" with value \"" + value + "\" to double", e);
				return 0;
			}
		} else {
			LOGGER.warning("Property \"" + key + "\" is undefined");
	...
	public boolean getBoolean(String key) {
		...
		if (value != null) {
			try {
				...
				//TODO Logger.log(Level.WARNING, "Could not convert property \"" + key + "\" with value \"" + value + "\" to boolean", e);
				return false;
			}
		} else {
			LOGGER.warning("Property \"" + key + "\" is undefined");
