...
public  class CoapResource implements Resource {
	...
	public void addObserveRelation(ObserveRelation relation) {
		if (observeRelations.add(relation)) {
			//TODO Logger.info("Replacing observe relation between "+relation.getKey()+" and resource "+getURI());
		} else {
			//TODO Logger.info("Successfully established observe relation between "+relation.getKey()+" and resource "+getURI());
		}
		for (ResourceObserver obs:observers)
